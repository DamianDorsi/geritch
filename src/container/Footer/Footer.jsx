  ...
  <div className="app__footer section__padding" id="login">
    ...
    <div className="app__footer-links">
      <div className="app__footer-links_contact">
        ...
        <p className="p__opensans">1137738387</p>
        <p className="p__opensans">1137738387</p>
      </div>

      <div className="app__footer-links_logo">
        <img src={images.gericht} alt="footer_logo" />  
        <p className="p__opensans">&quot;Los mejores platos con los ingredientes de mejor calidad.&quot;</p>
      ...
      <div className="app__footer-links_work">
        ...
        <p className="p__opensans">Lunes - Jueves:</p>
        <p className="p__opensans">10:00 am - 02:00 am</p>
        <p className="p__opensans">Viernes - Domingo:</p>
